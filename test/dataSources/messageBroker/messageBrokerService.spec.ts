...
describe('Message Broker', () => {
  ...
  it('Teste enviar para fila', async () => {
    ...
    const result = await messageService.enviaParaFila<MockType>(mockTest, sendQueue);
  ...
  it('Teste enviar para fila DLQ', async () => {
    ...
    const result = await messageService.enviaParaDLQ(sendQueue, `${sendQueue}_dlq`, mockSQSResponse);
  ...
  it('Teste deletar mensagem processada', async () => {
    ...
    const result = await messageService.deletaMensagemProcessada(sendQueue, mockReceiptHandle);
